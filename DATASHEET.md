...
Following the *Datasheets for Datasets* framework (Gebru et al., 2021). This documents the **anonymized, slur-masked** corpus released in this repository. Statistics are drawn from the accompanying study (*Media and Communication*).
...
- **Who created it and for whom?** Created by the study author(s) for scholarly research.
- **Funding.** See the manuscript's Funding statement.
...
- **Who collected/annotated it?** **Two coders** independently annotated each item (six-class scheme); labels were reconciled into `FineLabel`.
...
- **What is withheld and why?** The **unmasked scoring file** is withheld to limit potential harm; access conditions are described in this datasheet. **Interview transcripts** are **not released** because participant consent and safety preclude it.
...
- **Who maintains it?** Endalkachew H. Chala (see [`CITATION.cff`](CITATION.cff)).
